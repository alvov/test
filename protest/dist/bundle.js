...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__states_EndMenu_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__states_Game_js__ = __webpack_require__(4);
...
class Game {
    ...
    create() {
        ...
        this.game.mz.groups.cops = this.game.add.group();
        for (let i = 0; i < COPS_COUNT; i++) {
            ...
            this.game.mz.groups.cops.add(cop.sprite);
        }
    ...
    update() {
        ...
        this.game.physics.arcade.overlap(
            this.game.mz.objects.protester.sprite,
            this.game.mz.groups.cops,
            () => {
                // this.endGame();
            },
            ({ mz: protester }, { mz: cop }) => {
                return cop.target === protester;
            }
        );
    }
...
class EndMenu {
    create() {
        console.log(this.game.mz.eventHandler);
